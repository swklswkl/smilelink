...
.content{}
    ...
    .slideTxtBox .hd ul li{ float:left; padding:0 50px; cursor:pointer; font-size: 20px;color: #3c3c3c ;border-radius: 30px 30px 0 0; }
...
<body>
    ...
    <div class="content">
        <div class="slideTxtBox">
            <div class="hd">
                <ul >
                    <li id="qbdd">全部订单（-）</li><li id="dfk">代付款（-）</li><li id="yfk">已付款（-）</li><li id="ytjsj">已提交设计（-）</li><li id="yjs">已结束（-）</li>
                </ul>
            </div>
            <div class="bd">
                <!--全部订单-->
                    ...
                    <div class="tableBox">
                        <div class="content">
                            <div class="table">
                                <table class="table table-condensed table-hover">
                                    <tr class="success">
                                        <td style="text-align: left;padding-left: 31px;">病历号</td>
                                        <td>患者姓名</td>
                                        <td>创建日期</td>
                                        <td>病例状态</td>
                                        <td>服务类型</td>
                                    ...
                                    <tr class="active">
                                        <td  style="text-align: left;padding-left: 31px;">XX10086</td>
                                        <td >小熊</td>
                                        <td >2017/8/8</td>
                                        <td>治疗中</td>
                                        <td >隐形正畸矫治</td>
                                    ...
                                    <tr class="active">
                                        <td style="text-align: left;padding-left: 31px;">XX10010</td>
                                        <td >小雪</td>
                                        <td >2017/8/8</td>
                                        <td>分析报告已上传</td>
                                        <td >隐形正畸矫治</td>
