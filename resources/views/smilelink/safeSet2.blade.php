...
<div class="bg" id="pw">
    <div class="box" >
        <p   style="text-align: right;margin-bottom: 40px;cursor: hand"><sapn style="margin-right: 15px" id="cancelPw" >X</sapn></p>
        <p>
            <input type="password" id="ysmm" placeholder="请输入原始密码" class="input1">
        </p>
        <p>
            <input type="password" id="xmm" placeholder="请输入新密码" class="input1">
        </p>
        <p>
            <input type="password" id="qrmm" placeholder="请再次输入新密码" class="input2">
        </p>
        <div class="ensure" onclick="changepwd()">
            确 &nbsp;&nbsp;&nbsp;定
        </div>
    </div>
</div>
