<style>
    #mingcheng .form-horizontal .control-label {text-align: left}
    #zhaopian .form-horizontal .control-label {text-align: left}
    #xguangzhao .form-horizontal .control-label {text-align: left}
</style>
    ...
    <div class="modal-content" id="contenta">
        <div class="modal-body">
            <ul id="myTab1" class="nav nav-tabs">
                <li  class="active">
                    <a href="#mingcheng" data-toggle="tab" onclick="cc($('#mingcheng').height())">
                        名称和内容
                    </a>
                </li>
                <li>
                    <a href="#zhaopian" data-toggle="tab" onclick="cc($('#zhaopian').height())">
                        照片
                    </a>
                </li>
                <li>
                    <a href="#xguangzhao" data-toggle="tab" onclick="cc($('#xguangzhao').height())">
                        X光照
                    </a>
                </li>
            </ul>
            <div id="myTabContent1" class="tab-content">
                <div class="tab-pane fade in active" id="mingcheng">
                    <div class="container bs-docs-container" style="max-width: 700px;">
                        <div class="row form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" id="inputEmail3" value="{{$data[0]['name']}}" disabled>
                                </div>
                            </div>
                            <hr>
                            <label for="inputPassword3" class="col-sm-2 control-label" style="font-weight: 400;padding-left: 0">内容</label>
                            <div class="form-group">
                                <textarea class="form-control" rows="5" disabled>{{$data[0]['content']}}</textarea>
                            </div>
                            <div class="form-group">
                                <br>
                                &ensp;
                ...
                <div class="tab-pane fade" id="zhaopian">
                    <div class="container bs-docs-container" style="max-width: 700px;">
                        <div class="row">
                            <div class="form-group">
                                <h3>照片&ensp;</h3>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    <?php if ($data[0]['positive_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['positive_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['side_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['side_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>侧面照</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['positive_smile_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['positive_smile_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>正面微笑照</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['upper_arch_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['upper_arch_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>上牙弓照</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['positive_45_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['positive_45_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>正面咬合向上45度像</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['under_arch_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['under_arch_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>下牙弓像</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['right_bite_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['right_bite_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>右咬合像</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['positive_bite_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['positive_bite_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>正面咬合像</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['left_bite_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['left_bite_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>左咬合像</h5>
                                    </div>
                ...
                <div class="tab-pane fade" id="xguangzhao">
                    <div class="container bs-docs-container" style="max-width: 700px;">
                        <div class="row">
                            <div class="form-group">
                                <h3>X光片&ensp;</h3>
                            ...
                            <div class="form-group">
                                <div class="col-sm-4">
                                    <?php if ($data[0]['side_x_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['side_x_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>侧面x光片</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['positive_x_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['positive_x_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>正面x光片</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['tooth_photo'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['tooth_photo']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>牙片</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['cbct_joint_sagittal'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['cbct_joint_sagittal']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>CBCT关节矢状位</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['cbct_coronary_joint'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['cbct_coronary_joint']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>CBCT关节冠状位</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['cbct_anterior_teeth'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['cbct_anterior_teeth']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>CBCT上前牙牙根</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['cbct_under_teeth'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['cbct_under_teeth']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>CBCT下前牙牙根</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['abnormal_teeth'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['abnormal_teeth']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>异常牙</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    <?php if ($data[0]['air_passage'] == ''): ?>
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['air_passage']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>气道</h5>
                                    </div>
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <img src="holder.js/200x200?text=暂无图片"  class="img-thumbnail">
                                    <?php else: ?>
                                    <img src="{{$data[0]['other']}}" width="200" height="200" class="img-thumbnail">
                                    <?php endif; ?>
                                    <div class="caption" style="text-align: center">
                                        <h5>其它</h5>
                                    </div>
...
<script>
    ...
    function cc (a)
    {
        if (a > 820)
        {
            $('#contenta').css('height','827px');
            $('#contenta').css('overflow','scroll');
        }else{
            $('#contenta').css('height','');
            $('#contenta').css('overflow','');
        }
    }
</script>